# a natural language processing chat bot from https://app.pluralsight.com/guides/build-a-chatbot-with-python
import nltk
...
set_pairs = [
    ...
    [
        r"what is your name?",
        ["You can call me farfrom poopin' ",]
    ],
    [
        r"how are you ?",
...
def chatbot():
    print("Yo, wassup motherfucker, I'm a shitty chat machine!")
